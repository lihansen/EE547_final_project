...
<div class="register-wrap">
  ...
  <div class="form-wrap">
    ...
    <input class="input" type="email" placeholder="input the email" autocomplete="off" v-model="email" @blur="inputBlur" id="email">
    <input class="input" type="password" placeholder="input the password" v-model="password" @blur="inputBlur" id="password">
    <code-input
      :email="email"
      @code-tip="_emitTip"
      ref="codeInput"
  ...
  methods: {
    ...
    register () {
      ...
      if (user.password.length < 6) {
        this._emitTip('Password must longer than 6 digits !')
        return
      }
